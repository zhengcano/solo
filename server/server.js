...
mongoose.connect('mongodb://zheng:Corsec!23@ds033217.mongolab.com:33217/solo'); // connect to mongo database named shortly
...
/* Walkthrough of the server
  ...
  middleware.js requires all epxpress middleware and sets it up
